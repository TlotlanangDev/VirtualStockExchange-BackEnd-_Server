package com.tlotlanang.virtualstockexchangebackend.User.InvestmentBanker.listingDecision.entity;
...
@Entity
@Table(name = "MainListingAcc")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ListingDecisionEntity {
